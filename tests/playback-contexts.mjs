...
try {
  ...
  assert(await page.locator(".inspector").isVisible(), "Desktop Discover playback needs the side player.");
  ...
  console.log("Journey/global playback-context isolation passed.");
} finally {
  await browser.close();
}
